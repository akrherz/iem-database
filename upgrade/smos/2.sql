...
GRANT SELECT on data_2017_01 to nobody;
...
GRANT SELECT on data_2017_02 to nobody;
...
GRANT SELECT on data_2017_03 to nobody;
...
GRANT SELECT on data_2017_04 to nobody;
...
GRANT SELECT on data_2017_05 to nobody;
...
GRANT SELECT on data_2017_06 to nobody;
...
GRANT SELECT on data_2017_07 to nobody;
...
GRANT SELECT on data_2017_08 to nobody;
...
GRANT SELECT on data_2017_09 to nobody;
...
GRANT SELECT on data_2017_10 to nobody;
...
GRANT SELECT on data_2017_11 to nobody;
...
GRANT SELECT on data_2017_12 to nobody;
