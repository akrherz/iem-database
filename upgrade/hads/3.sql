...
GRANT SELECT on raw2016 to nobody;
...
grant select on raw2016_01 to nobody;
...
grant select on raw2016_02 to nobody;
...
grant select on raw2016_03 to nobody;
...
grant select on raw2016_04 to nobody;
...
grant select on raw2016_05 to nobody;
...
grant select on raw2016_06 to nobody;
...
grant select on raw2016_07 to nobody;
...
grant select on raw2016_08 to nobody;
...
grant select on raw2016_09 to nobody;
...
grant select on raw2016_10 to nobody;
...
grant select on raw2016_11 to nobody;
...
grant select on raw2016_12 to nobody;
