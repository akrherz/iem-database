...
GRANT SELECT on hml_forecast_data_2018 to nobody;
...
GRANT SELECT on hml_observed_data_2018 to nobody;
...
GRANT SELECT on raw2018 to nobody;
...
grant select on raw2018_01 to nobody;
...
grant select on raw2018_02 to nobody;
...
grant select on raw2018_03 to nobody;
...
grant select on raw2018_04 to nobody;
...
grant select on raw2018_05 to nobody;
...
grant select on raw2018_06 to nobody;
...
grant select on raw2018_07 to nobody;
...
grant select on raw2018_08 to nobody;
...
grant select on raw2018_09 to nobody;
...
grant select on raw2018_10 to nobody;
...
grant select on raw2018_11 to nobody;
...
grant select on raw2018_12 to nobody;
...
grant select on t2018 to nobody;
