...
GRANT SELECT on hml_forecast_data_2019 to nobody;
...
GRANT SELECT on hml_observed_data_2019 to nobody;
...
GRANT SELECT on raw2019 to nobody;
...
grant select on raw2019_01 to nobody;
...
grant select on raw2019_02 to nobody;
...
grant select on raw2019_03 to nobody;
...
grant select on raw2019_04 to nobody;
...
grant select on raw2019_05 to nobody;
...
grant select on raw2019_06 to nobody;
...
grant select on raw2019_07 to nobody;
...
grant select on raw2019_08 to nobody;
...
grant select on raw2019_09 to nobody;
...
grant select on raw2019_10 to nobody;
...
grant select on raw2019_11 to nobody;
...
grant select on raw2019_12 to nobody;
