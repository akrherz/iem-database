...
GRANT SELECT on t1983_hourly to nobody;
...
GRANT SELECT on t1984_hourly to nobody;
...
GRANT SELECT on t1985_hourly to nobody;
...
GRANT SELECT on t1986_hourly to nobody;
...
GRANT SELECT on t1987_hourly to nobody;
...
GRANT SELECT on t1988_hourly to nobody;
...
GRANT SELECT on t1989_hourly to nobody;
...
GRANT SELECT on t1990_hourly to nobody;
...
GRANT SELECT on t1991_hourly to nobody;
...
GRANT SELECT on t1992_hourly to nobody;
...
GRANT SELECT on t1993_hourly to nobody;
...
GRANT SELECT on t1994_hourly to nobody;
...
GRANT SELECT on t1995_hourly to nobody;
...
GRANT SELECT on t1996_hourly to nobody;
...
GRANT SELECT on t1997_hourly to nobody;
...
GRANT SELECT on t1998_hourly to nobody;
...
GRANT SELECT on t1999_hourly to nobody;
