...
grant select on sbw_1986 to nobody;
...
grant select on sbw_1987 to nobody;
...
grant select on sbw_1988 to nobody;
...
grant select on sbw_1989 to nobody;
...
grant select on sbw_1990 to nobody;
...
grant select on sbw_1991 to nobody;
...
grant select on sbw_1992 to nobody;
...
grant select on sbw_1993 to nobody;
...
grant select on sbw_1994 to nobody;
...
grant select on sbw_1995 to nobody;
...
grant select on sbw_1996 to nobody;
...
grant select on sbw_1997 to nobody;
...
grant select on sbw_1998 to nobody;
...
grant select on sbw_1999 to nobody;
...
grant select on sbw_2000 to nobody;
...
grant select on sbw_2001 to nobody;
